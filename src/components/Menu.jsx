    ...
    <div className={menuActive ? 'menu active' : 'menu'} onClick={() => setMenuActive(false)}>
      ...
      <div className="menu__content" onClick={(e) => e.stopPropagation()}>
        <ul className="menu__list">
          ...
          <li className="menu__item">
            <a className="menu__link" href="#portfolio" onClick={closeMenu}>
              Портфолио
            </a>
          </li>
          <li className="menu__item">
            <a className="menu__link" href="#price" onClick={closeMenu}>
              Цены
            </a>
          </li>
          <li className="menu__item">
          ...
          <li className="menu__item">
            <a href="tel:+79670673934" className="menu__link">
              +7-967-067-39-34
            </a>
          </li>
          <li className="menu__item">
            <span className="menu__box-item">
              <a className="header__link" href="https://wa.me/79670673934" target="_blank">
                <svg
          ...
          <li className="menu__item">
            <span className="menu__box-item">
              <a className="menu__link" href="https://t.me/ishyar" target="_blank">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 48 48"
                  width="20px"
