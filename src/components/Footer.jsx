        ...
        <div className="footer__inner">
          <div className="footer__inner-socials">
            <ul className="footer__inner-socials-list">
              <li className="footer__inner-socials-item first">Мы в соцсетях</li>

              <li className="footer__inner-socials-item">
                <a
                  className="footer__inner-socials-link"
                  href="https://wa.me/79670673934"
                  target="_blank">
                  <svg
          ...
          <div className="footer__inner-items">
            <ul className="footer__inner-items-list">
              <li className="footer__inner-items-item first">Меню</li>
              <li className="footer__inner-items-item">
                <a className="footer__inner-items-link" href="#services">
                  Услуги
                </a>
              </li>
              <li className="footer__inner-items-item">
                <a className="footer__inner-items-link" href="#portfolio">
                  Портфолио
                </a>
              </li>
              <li className="footer__inner-items-item">
                <a className="footer__inner-items-link" href="#price">
                  Цены
                </a>
              </li>
              <li className="footer__inner-items-item">
                <a className="footer__inner-items-link" href="#about">
                  О нас
                </a>
              </li>
            </ul>
          ...
          <div className="footer__inner-contacts">
            ...
            <p className="footer__inner-contacts-text">
              <strong>Телефон:</strong> +7-967-067-39-34
            </p>
            <p className="footer__inner-contacts-text">
              <strong>Мы работаем:</strong> Пн-Вс 09:00-20:00
            </p>
          </div>
        </div>
      </div>
